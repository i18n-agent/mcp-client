 ...
 */
export function extractExistingApiKey(configPath, serverName) {
  try {
 ...
 */
export function preserveExistingConfig(configPath, serverName, newConfig) {
 ...
 */
export function writeIDEConfig(configPath, ideKey, env, mcpPath, sharedKey) {
