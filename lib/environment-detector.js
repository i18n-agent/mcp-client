 ...
 */
function detectNodeVersionManager(nodePath) {
  if (!nodePath) {
    return 'unknown';
  }
 ...
 * @returns {{shell: string, configFile: string|null}} - Shell type and config file path
 */
