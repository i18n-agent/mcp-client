 ...
 */
export async function verifyMCPProtocol(serverPath, env = {}, timeout = 10000) {
 ...
 * @returns {Promise<{success: boolean, message: string}>}
 */
export async function verifyAPIConnection(apiKey, serverUrl) {
  // Validate input
 ...
 */
export async function verifyMCPServer(serverPath, env = {}) {
 ...
 */
export function createVerificationReport(result) {
  const lines = [];
